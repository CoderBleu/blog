  ...
  <v-app-bar app :class="navClass" hide-on-scroll flat height="60">
    ...
    <div class="d-md-block d-none nav-container">
      ...
      <div class="float-right nav-title">
        ...
        <div class="menus-item">
          <a class="menu-btn" v-if="!user" @click="openLogin">
          ...
          <template v-else>
            ...
            />
            <ul class="menus-submenu">
              <li v-if="user.username !== 'test'">
                <router-link to="/user">
                  <i class="iconfont icongerenzhongxin"/> 个人中心
                </router-link>
              </li>
              <li>
                <a @click="admin"><i class="iconfont icongerenzhongxin"/> 后台管理</a>
              </li>
              <li>
...
export default {
  ...
  methods: {
    ...
    admin() {
      //window.open("http://admin.r2blog.cn", "_blank");
      window.open("localhost:9999", "_blank");
    },
    logout() {
